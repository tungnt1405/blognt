    ...
    <div>
        <header class="more-info-header flex justify-between items-center mt-2">
            ...
            <div class="btn-action">
                <button class="js-btn-add btn btn-outline btn-primary btn-sm md:mt-auto">@lang('admin/common.add')</button>
        ...
        <div class="more-info-content">
            ...
            <div class="mt-5 md mt-0 pt-4 md:col-span-2">
                ...
                <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    <div>
                        {{ Form::textarea('experience', null, ['class' => 'textarea textarea-bordered', 'id' => 'textarea__more-exp']) }}
                    </div>
                </div>
            </div>
            <div class="mt-5 md mt-0 pt-4 md:col-span-2">
                ...
                <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    <div>
                        {{ Form::textarea('project', null, ['class' => 'textarea textarea-bordered', 'id' => 'textarea__more-pj']) }}
                    </div>
                </div>
            </div>
            <div class="mt-5 md mt-0 pt-4 md:col-span-2">
                ...
                <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    <div>
                        {{ Form::textarea('career_goals', null, ['class' => 'textarea textarea-bordered', 'id' => 'textarea__more-career']) }}
                    </div>
                </div>
            </div>
        </div>
